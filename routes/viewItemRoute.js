...
router.get("/lost/:id", (req, res) => {
    ...
    collectionRef.get()
    .then((snapshot) => {
        res.render('viewItem', { data: snapshot.data(), id: snapshot.data().id, location: "lost", user: req.session.user });
    })
    .catch((error) => {
...
router.get("/found/:id", (req, res) => {
    ...
    collectionRef.get()
    .then((snapshot) => {
        res.render('viewItem', { data: snapshot.data(), id: snapshot.data().id, location: "found", user: req.session.user });
    })
    .catch((error) => {
        console.error('Error fetching data:', error);
    });
